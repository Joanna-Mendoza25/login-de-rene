...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Aviso de Privacidad ')); ?></div>
                ...
                <ol>
                    ...
                    <p>¿En cuántos días le daremos respuesta a su solicitud?
                      ...
                      <!-- <a class="btn btn-outline-primary me-md-5" href="<?php echo e(route('register.index')); ?>">Regresar</a> -->
...
&copy; 2022 Paleteria DJN.      Aviso de privacidad     |   Contáctanos
                ...
                <div class="form-group container">
                    <li class="nav-item active col-9">
                        <a class="btn btn-warning me-md-5" href=" <?php echo e(route('register.index')); ?> "> Regresar</a>
                    </li>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Seguridad\resources\views/aviso.blade.php ENDPATH**/ ?>